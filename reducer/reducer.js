...
var reducer = function (state = initialState, action) {
  switch (action.type) {
    ...
    case actionTypes.GetDataFromUrlForTree:
      ...
      var checkedlist=[];
      var markerAndIcons = markerAndIconsMap(action.urlDataForTree);
      ...
      var globalContentSearchResult = globalContentSearch(state.urlDataForMap?state.urlDataForMap:defaultMapData,checkedItem(treeConstructorResult,checkedlist),state.keyword,markerAndIcons);
